...
public final class RecoveryRuleV3 {
    /**
     * Auth 对象
     */
     ...
     * @param auth Auth对象
     */
    public RecoveryRuleV3(Auth auth) {
        this.auth = auth;
    }
     ...
     * @throws I2softException:
     */
    public Map describeRecoveryScript(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/recovery_rule/script", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyRecoveryScript(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/recovery_rule/script", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
