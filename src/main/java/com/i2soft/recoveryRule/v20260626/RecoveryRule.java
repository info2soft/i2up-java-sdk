package com.i2soft.recoveryRule.v20260626;
...
public final class RecoveryRule {
    ...
    public Map describeCoveringLogBackupSet(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/covering_log_backup_set", auth.cc_url);
    ...
    public Map getRecoveryBkServerAddr(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/get_bk_server_addr", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVerifyBackupMedia(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/verify_backup_media", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeSbtDbid(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/sbt_dbid", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listSbtContrlFile(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/sbt_contrlfile", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listTimingRecoveryOracleRcPointInfo(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/rc_sbt", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listDirPost(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/dir", auth.cc_url);
    ...
    public Map listRecoveryRuleStatus(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeRecoveryRule(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map startRecoveryRule(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map deleteRecoveryRule(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs createRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/recovery_rule", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
