package com.i2soft.dtrack.v20260209;
...
public final class Dtrack {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs takeSnapshotDtrackBackup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs deleteSnapshotDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs takeSnapshotCloneDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs deleteSnapshotCloneDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs scanDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs cancelScanDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs syncDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs cancelSyncDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs suspendDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs resumeDtrackBackup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map suspendDtrackGroup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map resumeDtrackGroup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/group/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map syncDtrackGroup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/group/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map cancelSyncDtrackGroup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/group/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map takeSnapshotDtrackGroup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/group/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map deleteSnapshotDtrackGroup(StringMap args) throws I2softException {
        String url = String.format("%s/dtrack/group/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
