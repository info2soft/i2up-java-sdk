package com.i2soft.hw.v20260209;
...
public final class GTS {
     ...
     * @throws I2softException:
     */
    public Map closeService(String uuid) throws I2softException {
        String url = String.format("%s/gts/service/%s", auth.cc_url, uuid);
     ...
     * @throws I2softException:
     */
    public Map listService(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/gts/service/%s", auth.cc_url, uuid);
