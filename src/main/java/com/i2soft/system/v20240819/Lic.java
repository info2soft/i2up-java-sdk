package com.i2soft.system.v20240819;
...
public final class Lic {
     ...
     */
    public byte[] downloadLicInfo(String uuid) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map describeMoveLicBind(StringMap args) throws I2softException {
        String url = String.format("%s/lic/move_lic_bind", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}