...
public final class BackupRuleV3 {
     ...
     * @throws I2softException:
     */
    public Map listYaShanTableSpaces(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_rule/yashan_table_spaces", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listSqlserverAliyunDatabase(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_rule/list_sqlserver_aliyun_database", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}