...
public final class CloudRehearse {
     ...
     * @throws I2softException:
     */
    public byte[] evacuateBatchRehearse(StringMap args) throws I2softException {
    ...
    public I2Rs.I2SmpRs listNpsvrRehearseStatus(String uuid) throws I2softException {
        String url = String.format("%s/cloud/rehearse/%s/status", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs listNpsvrRehearseProgress(String uuid) throws I2softException {
        String url = String.format("%s/cloud/rehearse/%s/progress", auth.cc_url, uuid);
        Response r = auth.client.put(url, new StringMap());
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map describeFlavor(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/rehearse/flavor_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}