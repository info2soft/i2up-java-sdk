...
public final class CloudPlatform {
     ...
     */
    public Map listCloudPlatformRegion(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map listRegions(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/platform/regions", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listProjects(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/platform/projects", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}