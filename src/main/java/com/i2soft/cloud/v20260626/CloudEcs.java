package com.i2soft.cloud.v20260626;
...
public final class CloudEcs {
     ...
     * @throws I2softException:
     */
    public Map listEcsStatus(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs startECS(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopECS(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/ecs/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map getTakeoverVPCInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/ecs/work_network_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs bindNode(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs untieNode(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/ecs/node_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs batchCreateEcs(StringMap args) throws I2softException {
        String url = String.format("%s/cloud/ecs/batch", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}