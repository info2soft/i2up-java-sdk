package com.i2soft.rep.v20260626;
...
public final class RepBackup {
    ...
    public Map deleteRepBackupBaseline(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/rep/backup/%s/cdp_bl_list", auth.cc_url, uuid);
        Response r = auth.client.delete(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listRepBackupOrphan(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/rep/backup/%s/orphan_list", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public byte[] downloadRepBackupOrphan(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/rep/backup/%s/orphan_download", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public Map deleteRepBackupSnapshot(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/rep/backup/%s/snapshot_list", auth.cc_url, uuid);
        Response r = auth.client.delete(url, args);
        return r.jsonToMap();
    }
