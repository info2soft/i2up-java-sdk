package com.i2soft.rep.v20240311;
...
public final class RepBackup {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateRepBackup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs syncTaskRepBackup(StringMap args) throws I2softException {
        args.put("operate", "sync_task");
        String url = String.format("%s/rep/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
