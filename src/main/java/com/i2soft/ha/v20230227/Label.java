package com.i2soft.ha.v20230227;
...
public final class Label {
     ...
     */
    public I2Rs.I2CreateRs createLabel(StringMap args) throws I2softException {
    ...
    public I2Rs.I2SmpRs modifyLabel(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/ha/service_label/%s", auth.cc_url, uuid);
