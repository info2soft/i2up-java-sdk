package com.i2soft.ha.v20260209;
...
public final class Cluster {
    ...
    public I2Rs.I2SmpRs createHaCluster(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyHaCluster(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/%s", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs deleteHaClusterHost(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/host", auth.cc_url);
    ...
    public I2Rs.I2SmpRs registerHaCluster(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/hello", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs startHaCluster(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopHaCluster(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map checkDupName(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/duplicate_name", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs listHaClusterIpDuplicate(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/cluster_ip_duplicate", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listHaClusterID() throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/cluster_uuid", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listHaClusterStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/cls_pool/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}