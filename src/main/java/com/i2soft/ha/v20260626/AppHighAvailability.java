package com.i2soft.ha.v20260626;
...
public final class AppHighAvailability {
    ...
    public Map listNicInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/netif", auth.cc_url);
    ...
    public Map describeHAScriptPath(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/script_path", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeVolumeInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/volume_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs createHA(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha", auth.cc_url);
    ...
    public I2Rs.I2SmpRs haVerifyName(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/verify_name", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map describeHA(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/ha/%s", auth.cc_url, uuid);
    ...
    public Map listHAStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/status", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map startHA(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map stopHA(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map forceSwitchHA(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listStageOptions() throws I2softException {
        String url = String.format("%s/vers/v3/ha/group/stage_options", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map createHAGroup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/group", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs modifyHAGroup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/group/%s", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map forceSwitchHAGroup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/group/%s/task", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listHASwitchTaskStatus(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/ha/group/%s/task/status", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
