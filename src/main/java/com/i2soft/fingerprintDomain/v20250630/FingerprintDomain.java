package com.i2soft.fingerprintDomain.v20250630;
...
public final class FingerprintDomain {
     ...
     * @throws I2softException:
     */
    public Map operateFingerprintDomain(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fingerprint_domain/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
}