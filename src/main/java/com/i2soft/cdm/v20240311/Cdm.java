package com.i2soft.cdm.v20240311;
...
public final class Cdm {
     ...
     * @throws I2softException:
     */
    public Map operateCdmDrill(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs failbackCdmRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs failoverCdmRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs finishCdmRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs moveCdmRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs autoDrillCdmRule() throws I2softException {
        String url = String.format("%s/cdm_rule/", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs createCdmRemoteCoopy(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateCdmRemoteCoopy(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs verifyCdmRemoteCoopyDiskSpace(StringMap args) throws I2softException {
        String url = String.format("%s/cdm_remote_coopy/verify_disk_space", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
