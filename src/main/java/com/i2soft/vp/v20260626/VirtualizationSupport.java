package com.i2soft.vp.v20260626;
...
public final class VirtualizationSupport {
    ...
    public Map describeVmProtectRate(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dashboard/vp_vm", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map createVpBackup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup", auth.cc_url);
    ...
    public Map modifyVpBackup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/group/%s", auth.cc_url, uuid);
    ...
    public Map describeVpBackup(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/%s", auth.cc_url, uuid);
    ...
    public Map listVpBackupGroup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/group", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVpBackupStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map startVpBackup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs deleteVpBackupPoint(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/backup/backup_data", auth.cc_url);
        Response r = auth.client.delete(url, args);
    ...
    public I2Rs.I2SmpRs createVpRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/recovery", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map describeVpRecoveryGroup(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/vp/recovery/group/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listVpRecoveryStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/recovery/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs startVpRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/recovery/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map createVpMove(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/move", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map createVpRep(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs batchCreateVpRep(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/batch", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map modifyVpRepGroup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/group/%s", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeVpMove(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/vp/move/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map describeVpRep(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listVpMoveStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/move/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVpRepStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs stopVpMove(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/move/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs stopVpRep(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listVpRepPointList(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/%s/point_list", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs delPoint(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/%s/point", auth.cc_url, uuid);
        Response r = auth.client.delete(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map describeSnapshotInfo(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/rep/%s/snapshot_info", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVpDrill(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/drill", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeVpDrill(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/vp/drill/group/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listVpDrillStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/drill/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getConsoleUrl(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/drill/console_url", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map stopVpDrill(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/drill/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs createVpFileRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/file_recovery", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs modifyVpFileRecovery(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/file_recovery/%s", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map attachVpFileRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/file_recovery/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVpFileRecoveryStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/file_recovery/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
