package com.i2soft.dedupeStorage.v20260626;
...
public final class DedupeStorage {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyDedupeStorageService(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dedupe_storage/%s/service", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
