package com.i2soft.backupDomain.v20260626;
...
public final class BackupDomain {
    ...
    public Map listTargetDomainStorageUnit(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_domain/storage_unit", auth.cc_url);
    ...
    public Map listTargetDomainStorageUnitStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_domain/storage_unit_status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public byte[] createBackupDomain(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_domain", auth.cc_url);
    ...
    public byte[] modifyBackupDomain(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_domain/%s", auth.cc_url, uuid);
    ...
    public Map authBackupDomain(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/backup_domain/auth", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
