package com.i2soft.ruleVersion.v20260626;
...
public final class RuleVersion {
     ...
     * @throws I2softException:
     */
    public Map setMainRuleVersion(StringMap args) throws I2softException {
        String url = String.format("%s/rule_version/operate", auth.cc_url);
