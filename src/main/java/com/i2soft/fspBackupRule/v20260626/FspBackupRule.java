package com.i2soft.fspBackupRule.v20260626;
...
public final class FspBackupRule {
     ...
     * @throws I2softException:
     */
    public Map batchModifyFspBackupRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/backup_rule/batch_update", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToMap();
    }
