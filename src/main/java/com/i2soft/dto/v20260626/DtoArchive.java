...
public final class DtoArchive {
    ...
    public Map listDtoArchive(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive", auth.cc_url);
    ...
    public byte[] exportDtoArchiveData(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/export", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public I2Rs.I2SmpRs getDtoArchiveYear() throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/archive_year", auth.cc_url);
    ...
    public byte[] downloadDtoArchiveData(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/download", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public Map restoreDtoArchiveData(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/restore", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs createDtoArchiveReportRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/report_rule", auth.cc_url);
    ...
    public Map describeDtoArchiveReportRule(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/report_rule/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listDtoArchiveReportHistory(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/report_history", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listDtoArchiveReportStatistics(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/archive/report_statistics", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}