package com.i2soft.dto.v20260209;
...
public final class Dto {
    ...
    public Map listDtoRuleSyncStatus(StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/sync_status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs failRestartReportDtoRule(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/%s/fail_retry", auth.cc_url, uuid);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map failRestartReportDtoRuleResult(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/%s/fail_retry_result", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs listDtoRuleSourcePath(StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/source_path_list", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map getDtoRecoveryPoint(StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/rc_point", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public byte[] downloadDtoRuleReport(StringMap args) throws I2softException {
        String url = String.format("%s/dto/rule/download_report", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
}