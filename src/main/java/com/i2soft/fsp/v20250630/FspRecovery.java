package com.i2soft.fsp.v20250630;
...
public final class FspRecovery {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs startFspRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopFspRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/fsp/recovery/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs moveFspRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/fsp/recovery/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs rebootFspRecovery(StringMap args) throws I2softException {
        String url = String.format("%s/fsp/recovery/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listFspRecoveryDriverListUrl() throws I2softException {
        String url = String.format("%s/fsp/recovery/driver_url_list", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map getFspMoveBiosType(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/move/bios_type", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}