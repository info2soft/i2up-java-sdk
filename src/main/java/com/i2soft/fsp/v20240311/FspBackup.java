...
public final class FspBackup {
    ...
    public Map listNodeNetworks(StringMap args) throws I2softException {
        String url = String.format("%s/fsp/move/networks", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateFspMove(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopFspMove(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs moveFspMove(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs rebootFspMove(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateFspBackup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopFspBackup(StringMap args) throws I2softException {
        args.put("operate", "stop");
        String url = String.format("%s/fsp/backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs finishFspBackup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs failoverFspBackup(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs failbackFspBackup(StringMap args) throws I2softException {
