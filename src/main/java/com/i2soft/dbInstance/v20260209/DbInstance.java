package com.i2soft.dbInstance.v20260209;
...
public final class DbInstance {
    ...
    public Map verifyDbInstances(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/db_instance/verify", auth.cc_url);
    ...
    public Map describeDbInstance(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/db_instance/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listDbs(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/db_instance/list_db", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listTables(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/db_instance/list_tables", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listTableSpaces(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/db_instance/list_table_spaces", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}