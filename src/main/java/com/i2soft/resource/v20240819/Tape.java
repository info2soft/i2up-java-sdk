...
public final class Tape {
    ...
    public Map listTapeLibraryStatus(StringMap args) throws I2softException {
        String url = String.format("%s/tape_library/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs exportTapeMedia(StringMap args) throws I2softException {
        String url = String.format("%s/tape_media/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map modifyTapeLibraryRoboticArm(StringMap args) throws I2softException {
        String url = String.format("%s/tape_library/robotic_arm", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listTapeLibraryBackupSvrDrivers(StringMap args) throws I2softException {
        String url = String.format("%s/tape_library/backup_svr_drivers", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs modifyTapeLibraryBackupSvr(StringMap args) throws I2softException {
        String url = String.format("%s/tape_library/backup_svr", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
