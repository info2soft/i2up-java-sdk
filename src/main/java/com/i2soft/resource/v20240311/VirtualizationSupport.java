...
public final class VirtualizationSupport {
     ...
     * @throws I2softException:
     */
    public Map listDatastoreDir(String uuid1, String uuid2, StringMap args) throws I2softException {
        String url = String.format("%s/vp/platform/%s/datastore_dir", auth.cc_url, uuid1, uuid2);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs dl(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs listBakVerByIp(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs listBakVerInfoByIp(StringMap args) throws I2softException {
