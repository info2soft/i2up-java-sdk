...
public final class CopyVolume {
     ...
     * @throws I2softException:
     */
    public Map operateCopyVolume(StringMap args) throws I2softException {
        String url = String.format("%s/copy_volume/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listCopyCdmVolume(StringMap args) throws I2softException {
        String url = String.format("%s/copy_volume/copy_cdm_volume", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listCopyVolumeClient(StringMap args) throws I2softException {
        String url = String.format("%s/copy_volume/client_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}