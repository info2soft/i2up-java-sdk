...
public final class ContainerCluster {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyContainerCluster(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/container_cluster/%s", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateCallbackSettings(StringMap args) throws I2softException {
