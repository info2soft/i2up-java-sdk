...
public final class ActiveNode {
     ...
     */
    @Deprecated
    public I2Rs.I2SmpRs checkDbLinkDeprecated(StringMap args) throws I2softException {
    ...
    public Map createDb(StringMap args) throws I2softException {
        String url = String.format("%s/active/db(old_version)", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs restartAllProcess(StringMap args) throws I2softException {
