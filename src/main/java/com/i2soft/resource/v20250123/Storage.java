...
public final class Storage {
     ...
     * @throws I2softException:
     */
    public Map modifyStorageQuota(String uuid1, String uuid2, StringMap args) throws I2softException {
        String url = String.format("%s/storage/%s/quota/%s", auth.cc_url, uuid1, uuid2);
        Response r = auth.client.put(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public byte[] createVMDK() throws I2softException {
     ...
     * @throws I2softException:
     */
    public byte[] deleteVMDK() throws I2softException {
        String url = String.format("%s/storage/vmdk", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public Map listIscsiTargetList(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map createTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs eraseTape(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs formatTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs browseTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs rebuildCatalogTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs catalogTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs unloadTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs importTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs exportTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs updatePoolsTape(StringMap args) throws I2softException {
        String url = String.format("%s/tape/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map discribeTapeDetail(StringMap args) throws I2softException {
        String url = String.format("%s/tape/details", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listTapePools(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listTapePoolSlots(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool/list_slots", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs addSlotTapePool(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs removeSlotTapePool(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs updateTapePool(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map listTapeNames(StringMap args) throws I2softException {
        String url = String.format("%s/tape_pool/tape_names", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}