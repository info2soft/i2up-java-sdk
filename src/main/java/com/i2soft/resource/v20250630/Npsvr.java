...
public final class Npsvr {
    ...
    public I2Rs.I2SmpRs createNpsvr(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/vp/npsvr", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyNpsvr(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/vp/npsvr/%s", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs npsvrOperate(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/vp/npsvr/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listConfigItems(String uuid) throws I2softException {
        String url = String.format("%s/vp/npsvr/%s/list_config_items", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs updateConfigItems(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vp/npsvr/%s/update_config_items", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}