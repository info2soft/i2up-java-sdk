...
public final class HdfsPlatform {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs refreshHdfsHiveEntity(StringMap args) throws I2softException {
        String url = String.format("%s/hdfs_platform/refresh_hive_entity", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map maintainHdfsPlatform(StringMap args) throws I2softException {
        String url = String.format("%s/hdfs_platform/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listHdfsPlatformStatus(StringMap args) throws I2softException {
        String url = String.format("%s/hdfs_platform/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}