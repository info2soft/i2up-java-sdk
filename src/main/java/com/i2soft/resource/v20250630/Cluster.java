...
public final class Cluster {
    ...
    public Map listGaussHcsInstances(StringMap args) throws I2softException {
        String url = String.format("%s/cls/gauss_hcs_instances", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listGaussHcsDefaultInstance(StringMap args) throws I2softException {
        String url = String.format("%s/cls/gauss_hcs_default_instance", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listGaussTpopSolution() throws I2softException {
        String url = String.format("%s/cls/gauss_tpop_solution", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listGaussTpopDefaultInstance(StringMap args) throws I2softException {
        String url = String.format("%s/cls/gauss_tpop_default_instance", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map clsGoldenDBInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/golden_db_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map clsMongoDBInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/mongo_db_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map clsTdsqlDBInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/tdsql_db_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs clsDorisInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/doris_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs tidbVerify(StringMap args) throws I2softException {
        String url = String.format("%s/cls/tidb_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listRacInstances(StringMap args) throws I2softException {
        String url = String.format("%s/cls/rac_instances", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getTdsqlInstanceDefaultInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/tdsql_default_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getTdsqlInstanceDefaultMachineInfo(StringMap args) throws I2softException {
        String url = String.format("%s/cls/tdsql_default_machine_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}