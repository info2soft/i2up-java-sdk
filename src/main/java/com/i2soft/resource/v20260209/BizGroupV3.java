...
public final class BizGroupV3 {
    ...
    public I2Rs.I2SmpRs createBizGroup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/biz_grp", auth.cc_url);
    ...
    public Map listBizGroupResource(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/biz_grp/res", auth.cc_url);
    ...
    public Map listBizGroupBind(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/biz_grp/%s/bind", auth.cc_url, uuid);
     ...
     * @throws I2softException:
     */
    public Map deleteBizGroup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/biz_grp", auth.cc_url);
    ...
    public Map describeBizGroup(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/biz_grp/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
