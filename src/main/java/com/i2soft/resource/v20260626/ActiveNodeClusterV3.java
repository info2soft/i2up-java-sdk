...
public final class ActiveNodeClusterV3 {
    /**
     * Auth 对象
     */
     ...
     * @param auth Auth对象
     */
    public ActiveNodeClusterV3(Auth auth) {
        this.auth = auth;
    }
     ...
     * @throws I2softException:
     */
    public Map listActiveNodeClusterCandidates(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/active/node_cluster/candidate", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs migrateActiveNodeCluster(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/active/node_cluster/migrate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}