...
public final class StorageUnit {
    ...
    public I2Rs.I2SmpRs createStorageUnit(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyStorageUnit(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit/%s", auth.cc_url, uuid);
    ...
    public Map listStorageUnitStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map chkStorageUnitRules(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit/rules_chk", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map nasVerify(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit/nas_verify", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs createStorageUnitGroup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit_group", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs modifyStorageUnitGroup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit_group/%s", auth.cc_url, uuid);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map getStorageUnitAvailableConcurrent(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_unit/available_concurrent", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}