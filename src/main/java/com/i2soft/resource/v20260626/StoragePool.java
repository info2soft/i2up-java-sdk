...
public final class StoragePool {
    ...
    public Map availablePoolMemberList(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/available_pool_member", auth.cc_url);
    ...
    public Map createStoragePool(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map modifyStoragePool(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/%s", auth.cc_url, uuid);
    ...
    public Map listStoragePoolStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listHbaInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/hba_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs deleteFcTarget(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/fc_target", auth.cc_url);
        Response r = auth.client.delete(url, args);
    ...
    public I2Rs.I2SmpRs resetStoragePool(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map storagePoolLoadPools(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/load_pools", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map storagePoolBatchImport(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/batch_import", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs storagePoolUpdateConfig(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/storage_pool/update_config", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}