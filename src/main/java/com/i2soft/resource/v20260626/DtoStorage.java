...
public final class DtoStorage {
    ...
    public I2Rs.I2SmpRs createDtoStorage(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyDtoStorage(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage/%s", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs modifyDtoStorageType(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage/storage_type", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listBuckets(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage/bucket_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs createBucket(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage/bucket", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map getDtoStorageStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dto/storage/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}