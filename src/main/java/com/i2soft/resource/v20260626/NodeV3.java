...
public final class NodeV3 {
    ...
    public Map authNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/auth", auth.cc_url);
    ...
    public Map listNodePackageList(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/package_list", auth.cc_url);
    ...
    public Map checkCapacity(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/check_capacity", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVg(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/vg", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listHostInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/host_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map checkNodeOnline(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/hello", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map batchSearchByPort(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/hello_port_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listNodeBindEcs(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/ecs_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map createNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map precreateNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/precreate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map modifyNode(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/%s", auth.cc_url, uuid);
    ...
    public Map createBatchNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/batch", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeDeviceInfo(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/node/%s/device_info", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map describeDriverLetter(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/node/%s/driver_letter", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs addSlaveNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/add_slave_node", auth.cc_url);
        Response r = auth.client.post(url, args);
    ...
    public Map batchModifyNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/batch_update", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeNodeInfo(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/%s/info", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs upgradeNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listNodeStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map nodeGetOracleInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/oracle_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map nodeGetMysqlInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/mysql_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map dataIpList(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/data_ip_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map modifyDataIp(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/data_ip", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listHbaInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/hba_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map checkUnbindEcs(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/check_unbind_ecs", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getNodeVersion(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/version", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map activeNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/active", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listWaitingActiveNode() throws I2softException {
        String url = String.format("%s/vers/v3/node/inactive_list", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public byte[] downloadNodeInstallScript(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/install_script", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public Map getNodePackageUrl(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/packge_url", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listRules(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/rules", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map deleteInactiveNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/inactive", auth.cc_url);
        Response r = auth.client.delete(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listNodeUkey(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/ukey", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listPlatform() throws I2softException {
        String url = String.format("%s/vers/v3/node/platform", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map listMysqlDatabases(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/mysql_databases", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listMysqlTables(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/mysql_tables", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map startNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map upgradeNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map reinstallNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map reinsmodNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map upgradeAndReinsmodNodeProcess(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/process_operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs batchAuthNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/batch_auth", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listKernels(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/kernels", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeFpServer(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node/fp_server", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}