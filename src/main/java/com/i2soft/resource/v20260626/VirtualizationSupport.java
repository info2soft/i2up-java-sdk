...
public final class VirtualizationSupport {
    ...
    public Map createVp(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform", auth.cc_url);
    ...
    public Map modifyVp(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/%s", auth.cc_url, uuid);
    ...
    public Map listVpStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs updateDataAgentVp(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
    ...
    public Map getVmInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/vm_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listVmDiskByUuid(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vp/platform/%s/vm_disk_list", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public byte[] importVmIpMapping(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/batch_vm_ip_mapping", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.body();
    }
    ...
    public Map listNetworkInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/network_info_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeOsVersion(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/os_version", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map tgtVmStatusInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/tgt_vm_status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listUsedIp(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vp/platform/%s/ip_used_list", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listPlatformStorage(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/storage/platform_storage_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs platformAuthorize(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/storage/platform_authorize", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listVpStorage(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/storage", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public byte[] listBakVerByIp(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/bk_ver_by_ip", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public byte[] listBakVerInfoByIp(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/bk_ver_info_by_ip", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
    ...
    public I2Rs.I2SmpRs testNode(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/test_node", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map getTargetVmInfo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/target_vm_info", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listDiskType(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/disk_type", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map discoveryVm(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/discovery_vm", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listOrganizations(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/list_organizations", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listResourceGroups(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/list_resource_groups", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listLianTongTenants(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/list_tenants", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map listLianTongRegions(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/vp/platform/list_regions", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}