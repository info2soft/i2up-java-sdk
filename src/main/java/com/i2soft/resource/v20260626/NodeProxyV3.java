...
public final class NodeProxyV3 {
    /**
     * Auth 对象
     */
    ...
    public I2Rs.I2SmpRs createNodeProxy(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/node_proxy", auth.cc_url);
    ...
    public Map describeNodeProxy(String uuid) throws I2softException {
        String url = String.format("%s/vers/v3/node_proxy/%s", auth.cc_url, uuid);
