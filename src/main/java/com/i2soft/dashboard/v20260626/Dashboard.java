package com.i2soft.dashboard.v20260626;
...
public final class Dashboard {
    ...
    public Map resourceView() throws I2softException {
        String url = String.format("%s/vers/v3/dashboard/source", auth.cc_url);
    ...
    public I2Rs.I2SmpRs resourceProtectionCoverage(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/dashboard/resource_protection_coverage", auth.cc_url);
    ...
    public Map taskView() throws I2softException {
        String url = String.format("%s/vers/v3/dashboard/task", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
