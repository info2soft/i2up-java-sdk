package com.i2soft.bigdataBackupRule.v20260209;
...
public final class BigdataBackupRule {
     ...
     * @throws I2softException:
     */
    public Map batchModifyBigdataBackupRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/bigdata/backup_rule/batch_update", auth.cc_url);
