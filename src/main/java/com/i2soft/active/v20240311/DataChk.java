...
public final class DataChk {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs startObjCmp(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs immediateObjCmp(StringMap args) throws I2softException {
        args.put("operate", "cmp_immediate");
        String url = String.format("%s/datacheck/obj_cmp/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs resumeTimeObjCmp(StringMap args) throws I2softException {
        args.put("operate", "resume_time");
        String url = String.format("%s/datacheck/obj_cmp/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopTimeObjCmp(StringMap args) throws I2softException {
        args.put("operate", "stop_time");
        String url = String.format("%s/datacheck/obj_cmp/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
