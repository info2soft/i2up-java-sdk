...
public final class Hetero {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2CreateRs modifyConsumerRule(StringMap args) throws I2softException {
        String url = String.format("%s/hetero/consumer/rule", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateConsumerRule(StringMap args) throws I2softException {
    ...
    public Map describeConsumerRules(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/hetero/consumer/%s", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
