...
public final class Tidb {
     ...
     */
    public I2Rs.I2CreateRs createTidbRule(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2CreateRs modifyTidbRule(StringMap args) throws I2softException {
        String url = String.format("%s/tidb/rule", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateTidbRule(StringMap args) throws I2softException {
