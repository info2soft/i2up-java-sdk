...
public final class ScriptMask {
    ...
    public I2Rs.I2SmpRs modifyScript(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/mask/script/%s", auth.cc_url, uuid);
    ...
    public byte[] downloadScript(StringMap args) throws I2softException {
        String url = String.format("%s/mask/script/download", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
     ...
     * @throws I2softException:
     */
    public Map descriptScript(Integer id, StringMap args) throws I2softException {
        String url = String.format("%s/mask/script/%s", auth.cc_url, id);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyScriptRule(StringMap args) throws I2softException {
        String url = String.format("%s/mask/script_rule", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map descriptRule(Integer id, StringMap args) throws I2softException {
        String url = String.format("%s/mask/script_rule/%s", auth.cc_url, id);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getScriptRuleResultDetail(String uuid) throws I2softException {
        String url = String.format("%s/mask/script_rule/status_detail/%s", auth.cc_url, uuid);
