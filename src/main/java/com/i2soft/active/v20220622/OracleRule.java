...
public final class OracleRule extends Rule {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2CreateRs createOracleRuleOld(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyOracleRuleOld(StringMap args) throws I2softException {
        String url = String.format("%s/active/rule", auth.cc_url);
        Response r = auth.client.put(url, args);
