...
public final class Mask {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifySensType(StringMap args, String uuid) throws I2softException {
    ...
    public Map descriptSensType(String uuid) throws I2softException {
        String url = String.format("%s/mask/sens_type/:id", auth.cc_url, uuid);
     ...
     * @throws I2softException:
     */
    public Map descriptAlgo (String uuid) throws I2softException {
        String url = String.format("%s/mask/algo/:id", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map describeMaskRule(String uuid) throws I2softException {
        String url = String.format("%s/mask/rule/:id", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map descriptMap(String uuid) throws I2softException {
        String url = String.format("%s/mask/sens_db_map/:id", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyMap(StringMap args, String uuid) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map listSensCheckResult(StringMap args, String uuid) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyMaskRules(StringMap args, String uuid) throws I2softException {
