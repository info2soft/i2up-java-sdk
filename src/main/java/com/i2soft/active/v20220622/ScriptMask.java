...
public final class ScriptMask {
     ...
     * @throws I2softException:
     */
    public Map descriptScript(StringMap args, String uuid) throws I2softException {
        String url = String.format("%s/mask/script/:id", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map descriptRule(StringMap args, String uuid) throws I2softException {
        String url = String.format("%s/mask/script_rule/:id", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
