...
public final class QianBaseSync {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs stopQianbaseRule(StringMap args) throws I2softException {
        String url = String.format("%s/qianbase/rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs restartQianbaseRule(StringMap args) throws I2softException {
        String url = String.format("%s/qianbase/rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
