...
public final class RoutingRule {
     ...
     */
    public I2Rs.I2SmpRs createReportRule(StringMap args) throws I2softException {
        String url = String.format("%s/stream_routing", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyReportRule(StringMap args) throws I2softException {
        String url = String.format("%s/stream_routing", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public Map listReportRuleStatus(StringMap args) throws I2softException {
        String url = String.format("%s/stream_routing/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs deleteReportRule(StringMap args) throws I2softException {
        String url = String.format("%s/stream_routing", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateReportRule(StringMap args) throws I2softException {
        String url = String.format("%s/stream_routing/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs listReportRuleHistory(StringMap args) throws I2softException {
