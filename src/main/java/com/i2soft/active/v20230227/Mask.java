...
public final class Mask {
    ...
    public I2Rs.I2SmpRs modifySensType(Integer id, StringMap args) throws I2softException {
        String url = String.format("%s/mask/sens_type/%s", auth.cc_url, id);
     ...
     * @throws I2softException:
     */
    public Map describeMaskRule(Integer id) throws I2softException {
        String url = String.format("%s/mask/rule/%s", auth.cc_url, id);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map descriptMap(Integer id) throws I2softException {
        String url = String.format("%s/mask/sens_db_map/%s", auth.cc_url, id);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyMap(Integer id, StringMap args) throws I2softException {
        String url = String.format("%s/mask/sens_map/%s", auth.cc_url, id);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifySensCheck(StringMap args, String uuid) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs modifyMaskRules(Integer id, StringMap args) throws I2softException {
        String url = String.format("%s/mask/rule/%s", auth.cc_url, id);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
