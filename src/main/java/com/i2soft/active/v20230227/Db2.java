...
public final class Db2 {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs createDb2Cmp(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map describeDb2Cmp(String uuid, StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs deleteDb2Rules(StringMap args) throws I2softException {
        String url = String.format("%s/db2/tb_cmp", auth.cc_url);
        Response r = auth.client.delete(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public Map listDb2Cmps(StringMap args) throws I2softException {
        String url = String.format("%s/db2/tb_cmp", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs cmpStopDb2Cmp(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map describeDb2CmpSingle(StringMap args) throws I2softException {
    ...
    public I2Rs.I2SmpRs exportCmpResult(StringMap args) throws I2softException {
        String url = String.format("%s/db2/rule/export", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
