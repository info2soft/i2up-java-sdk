package com.i2soft.fspRecoveryRule.v20260626;
...
public final class FspRecoveryRule {
     ...
     * @throws I2softException:
     */
    public Map listFspRecoveryRules(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/recovery_rule", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public Map powerOnFspRecoveryRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/recovery_rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map powerOffFspRecoveryRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/recovery_rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map openConsoleFspRecoveryRule(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/fsp/recovery_rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
