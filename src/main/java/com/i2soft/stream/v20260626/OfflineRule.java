...
public final class OfflineRule {
     ...
     * @throws I2softException:
     */
    public Map listOfflineRuleGroupStatus(StringMap args) throws I2softException {
        String url = String.format("%s/offline_rule_group/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map describeOfflineRuleGroup(String uuid) throws I2softException {
     ...
     * @throws I2softException:
     */
    public Map modifyOfflineRuleGroup(String uuid) throws I2softException {
        String url = String.format("%s/offline_rule_group/%s", auth.cc_url, uuid);
