package com.i2soft.vpBackupRule.v20240819;
...
public final class VpBackupRule {
     ...
     */
    public I2Rs.I2SmpRs createVpBackupRule(StringMap args) throws I2softException {
        String url = String.format("%s/vp/backup_rule", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyVpBackupRule(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vp/backup_rule/%s", auth.cc_url, uuid);
    ...
    public Map operateVpBackupRule(StringMap args) throws I2softException {
        String url = String.format("%s/vp/backup_rule/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listVpBackupRuleStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vp/backup_rule/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map taskAddVms(StringMap args) throws I2softException {
        String url = String.format("%s/vp/backup_rule/task_add_vms", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
}