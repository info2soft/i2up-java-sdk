package com.i2soft.cfs.v20260626;
...
public final class CfsBackup {
    ...
    public I2Rs.I2SmpRs createCfsBackup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup", auth.cc_url);
    ...
    public Map modifyCfsBackup(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/%s", auth.cc_url, uuid);
    ...
    public Map startCfsBackup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map failoverCfsBackup(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listCfsBackupStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listCfsBackupSyncStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/sync_status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map getWatingMoveNumber(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/waiting_move_number", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listCfsBackupHistory(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/cfs_backup/list_history", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map describeCfsBackupLetency(StringMap args) throws I2softException {
        String url = String.format("%s/cfs_backup/latency", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs checkCfsBackupCachedData(StringMap args) throws I2softException {
        String url = String.format("%s/cfs_backup/check_cached_data", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}