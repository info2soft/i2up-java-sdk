...
public final class Client {
    ...
    public I2Rs.I2SmpRs updateSlaveNode(StringMap args) throws I2softException {
        String url = String.format("%s/client/update_slave_node", auth.cc_url);
    ...
    public Map getVirtualPlatforms(StringMap args) throws I2softException {
        String url = String.format("%s/client/get_virtual_platforms", auth.cc_url);
    ...
    public Map getVirtualPlatformRules(StringMap args) throws I2softException {
        String url = String.format("%s/client/get_virtual_platform_rules", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs createCompareResult(StringMap args) throws I2softException {
        String url = String.format("%s/client/create_compare_result", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map collectCompareResult(StringMap args) throws I2softException {
        String url = String.format("%s/client/collect_compare_result", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs uploadCompareDiffDetail(StringMap args) throws I2softException {
        String url = String.format("%s/client/upload_diff_detail", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map getDtoStorageList(StringMap args) throws I2softException {
        String url = String.format("%s/client/get_dto_storage_list", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}