...
public final class Settings {
     ...
     * @throws I2softException:
     */
    public Map createAk() throws I2softException {
        String url = String.format("%s/ak", auth.cc_url);
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operatenpsvrBak(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateCcBakHistory(StringMap args) throws I2softException {
