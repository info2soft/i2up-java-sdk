...
public final class Qr {
     ...
     * @throws I2softException:
     */
    public byte[] createQrPic(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs cancelLogin(StringMap args) throws I2softException {
        String url = String.format("%s/qr/event", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs checkQrValidity(StringMap args) throws I2softException {
        String url = String.format("%s/qr/event", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
