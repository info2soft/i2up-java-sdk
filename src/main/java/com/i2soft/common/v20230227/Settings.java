...
public final class Settings {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs logout(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs npsvrBakRecovery(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs downloadCustomAudio() throws I2softException {
        String url = String.format("%s/sys/settings/custom_audio", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs chkEtcdUrl(StringMap args) throws I2softException {
        String url = String.format("%s/sys/settings/etcd_url_chk", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}