...
public final class StatisticsV3 {
     ...
     * @throws I2softException:
     */
    public Map listStatisticsRuleChart(StringMap args) throws I2softException {
    ...
    /**
     * 事件统计 - 整体统计 - 按规则统计 - download
     *
     * @param args: 参数详见 API 手册
     * @return 参数详见 API 手册
     * @throws I2softException:
     */
    public byte[] downloadStatisticsRuleChart(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/statistics/rule_chart", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.body();
    }
