...
public final class Lic {
     ...
     * @throws I2softException:
     */
    public Map listBackup9LicRes(StringMap args) throws I2softException {
        String url = String.format("%s/lic/backup9_res", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map describeLatestExpireLicense() throws I2softException {
        String url = String.format("%s/lic/latest_expire_license", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
}