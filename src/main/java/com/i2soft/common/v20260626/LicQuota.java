...
public final class LicQuota {
     ...
     * @throws I2softException:
     */
    public Map getLicQuotaSettings() throws I2softException {
        String url = String.format("%s/lic_quota/settings", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs updateLicQuotaSettings(StringMap args) throws I2softException {
        String url = String.format("%s/lic_quota/settings", auth.cc_url);
        Response r = auth.client.put(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
