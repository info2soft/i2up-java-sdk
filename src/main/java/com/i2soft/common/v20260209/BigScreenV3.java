...
public final class BigScreenV3 {
    /**
     * Auth 对象
     */
    ...
    public I2Rs.I2SmpRs createBigScreen(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen", auth.cc_url);
    ...
    public I2Rs.I2SmpRs modifyBigScreen(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/%s", auth.cc_url, uuid);
    ...
    public I2Rs.I2SmpRs uploadBigScreenLogo(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/logo", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listBigScreenLogo() throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/logo_list", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs configBigScreen(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/config", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public I2Rs.I2SmpRs clearBigScreenStatData(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/clear_data", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
    ...
    public Map listBigScreenStatRules(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/rules", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map describeBigScreenStat(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/stat", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listBigScreenGraph(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/big_screen/graph", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
}