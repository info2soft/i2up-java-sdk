package com.i2soft.notifications.v20230227;
...
public final class Notifications {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateNotifications(StringMap args) throws I2softException {
     ...
     * @throws I2softException:
     */
    public I2Rs.I2SmpRs operateNotificationsTemplate(StringMap args) throws I2softException {
        String url = String.format("%s/notifications/template/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToObject(I2Rs.I2SmpRs.class);
    }
}