package com.i2soft.nas.v20260626;
...
public final class Nas {
     ...
     */
    public Map createNAS(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/nas/sync", auth.cc_url);
    ...
    public Map listNasStatus(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/nas/sync/status", auth.cc_url);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map startNAS(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/nas/sync/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
     ...
     * @throws I2softException:
     */
    public Map stopNAS(StringMap args) throws I2softException {
        String url = String.format("%s/vers/v3/nas/sync/operate", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.jsonToMap();
    }
