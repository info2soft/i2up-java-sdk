package com.i2soft.backupWork.v20260209;
...
public final class BackupWork {
    ...
    public Map listBackupWork(StringMap args) throws I2softException {
        String url = String.format("%s/backup_work", auth.cc_url);
    ...
    public Map describeBackupWork(String uuid) throws I2softException {
        String url = String.format("%s/backup_work/%s", auth.cc_url, uuid);
    ...
    public Map listBackupWorkLogs(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/backup_work/%s/logs", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public Map listBackupWorkKeyEvents(String uuid) throws I2softException {
        String url = String.format("%s/backup_work/%s/key_events", auth.cc_url, uuid);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public Map describeBackupMigrateWorkResult(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/backup_work/%s/result_list", auth.cc_url, uuid);
        Response r = auth.client.get(url, args);
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs rebootBackupWork(StringMap args) throws I2softException {
        String url = String.format("%s/backup_work/operate", auth.cc_url);
    ...
    public byte[] downloadFailedFileList(StringMap args) throws I2softException {
        String url = String.format("%s/backup_work/download_failed_file_list", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.body();
    }
     ...
     * @throws I2softException:
     */
    public byte[] seVmpriority(StringMap args) throws I2softException {
        String url = String.format("%s/backup_work/set_vm_priority", auth.cc_url);
        Response r = auth.client.post(url, args);
        return r.body();
    }
    ...
    public Map listBackupWorkFilter() throws I2softException {
        String url = String.format("%s/backup_work_filter", auth.cc_url);
        Response r = auth.client.get(url, new StringMap());
        return r.jsonToMap();
    }
    ...
    public I2Rs.I2SmpRs modifyBackupWorkFilter(String uuid, StringMap args) throws I2softException {
        String url = String.format("%s/backup_work_filter/%s", auth.cc_url, uuid);
