...
import com.i2soft.active.v20250123.Tidb;
...
public class TidbTest {
    ...
    @Test
    public void T3089_stopTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.stopTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_restartTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.restartTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_startParsingTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.startParsingTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_stopParsingTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.stopParsingTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_resetParsingTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.resetParsingTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_startLoadTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.startLoadTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_stopLoadTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.stopLoadTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_resetLoadTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.resetLoadTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3089_removeTidbRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = tidb.removeTidbRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
