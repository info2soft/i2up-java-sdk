...
import com.i2soft.active.v20250123.DataChk;
...
public class DataChkTest {
    ...
    @Test
    public void T4028_restartObjCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "4028")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.restartObjCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T4028_cmpStopTimeObjCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "4028")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.cmpStopTimeObjCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T4028_cmpResumeTimeObjCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "4028")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.cmpResumeTimeObjCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T4028_cmpImmediateObjCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "4028")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.cmpImmediateObjCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    public void T2644_restartTbCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2644")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.restartTbCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T2644_resumeTbCmp() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2644")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dataChk.resumeTbCmp(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
