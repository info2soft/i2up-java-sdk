...
import com.i2soft.active.v20250123.Hetero;
...
public class HeteroTest {
    ...
    @Test
    public void T1598_createConsumerRule() {
        try {
    ...
    @Test
    public void T2069_modifyConsumerRule() {
        try {
    ...
    @Test
    public void T1599_deleteConsumerRules() {
        try {
    ...
    @Test
    public void T1600_listConsumerStatus() {
        try {
    ...
    @Test
    public void T1601_stopConsumerRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1601")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = hetero.stopConsumerRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1601_resumeConsumerRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1601")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = hetero.resumeConsumerRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1602_listConsumerRules() {
        try {
    ...
    @Test
    public void T1604_describeConsumerRules() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1604")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = hetero.describeConsumerRules(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1613_createHeteroGraph() {
        try {
    ...
    @Test
    public void T1614_addHeteroGraph() {
        try {
    ...
    @Test
    public void T1628_listHeteroGraph() {
        try {
    ...
    @Test
    public void T1629_runHeteroGraph() {
        try {
    ...
    @Test
    public void T1630_stopHeteroGraph() {
        try {
    ...
    @Test
    public void T1631_listGraphStatus() {
        try {
    ...
    @Test
    public void T1632_deleteHeteroGraph() {
        try {
    ...
    @Test
    public void T1635_descriptGraphDetail() {
        try {
    ...
    @Test
    public void T8277_importHeteroConsumerTopicMapping() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "8277")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = hetero.importHeteroConsumerTopicMapping(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
