...
import com.i2soft.resource.v20250123.DtoHost;
...
public class DtoHostTest {
    ...
    @Test
    public void T6603_deleteDtoHost() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "6603")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T6607_listDtoHostClusterNode() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "6607")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtoHost.listDtoHostClusterNode(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1080_deleteDtoHostClusterNode() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1080")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtoHost.deleteDtoHostClusterNode(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1819_upgradeDtoHost() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1819")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtoHost.upgradeDtoHost(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1819_maintainDtoHost() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1819")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtoHost.maintainDtoHost(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1819_renewKeyDtoHost() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1819")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtoHost.renewKeyDtoHost(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
