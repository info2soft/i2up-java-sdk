...
import com.i2soft.resource.v20250123.Monitor;
...
public class MonitorTest {
    ...
    @Test
    public void T774_listDriversInfo() {
        try {
    ...
    @Test
    public void T778_listChartData() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
    ...
    @Test
    public void T776_listChartConfig() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
    ...
    @Test
    public void T777_setChartConfig() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
    ...
    @Test
    public void T920_listBkNodeOverall() {
        try {
