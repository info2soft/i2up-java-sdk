package com.i2soft.i2up.v20220622.dtrack;

import com.i2soft.common.Auth;
import com.i2soft.dtrack.v20220622.Dtrack;
...
public class DtrackTest {
    ...
    @Test
    public void T1042_take_snapshotDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "take_snapshot");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_delete_snapshotDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "delete_snapshot");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    @Test
    public void T1042_take_snapshot_cloneDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "take_snapshot_clone");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    @Test
    public void T1042_delete_snapshot_cloneDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "delete_snapshot_clone");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    @Test
    public void T1042_cancel_scanDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "cancel_scan");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    @Test
    public void T1042_cancel_syncDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "cancel_sync");
            I2Rs.I2SmpRs rs = dtrack.operateDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    public void T1408_suspendDtrackGroup() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "suspend");
            Map rs = (Map) dtrack.operateDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_cancel_syncDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "cancel_sync");
    ...
    @Test
    public void T1408_take_snapshotDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "take_snapshot");
    ...
    @Test
    public void T1408_delete_snap_shotDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "delete_snap_shot");
            Map rs = (Map) dtrack.operateDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
