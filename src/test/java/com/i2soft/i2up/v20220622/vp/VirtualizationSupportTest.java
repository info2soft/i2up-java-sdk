package com.i2soft.i2up.v20220622.vp;
...
import com.i2soft.vp.v20220622.VirtualizationSupport;
...
public class VirtualizationSupportTest {
    ...
    public void T594_startVpBackup() {
        try {
            ...
            Map rs = virtualizationSupport.operateVpBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T594_start_immediatelyVpBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "594")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T594_auto_discoveryVpBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "594")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "auto_discovery");
            Map rs = virtualizationSupport.operateVpBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
    ...
    public void T620_startVpRecovery() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "start");
            Map rs = virtualizationSupport.operateVpRecovery(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T620_clear_finishVpRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "752")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    public void T605_startVpMove() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "start");
            I2Rs.I2SmpRs rs = (I2Rs.I2SmpRs) virtualizationSupport.operateVpMove(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T605_failoverVpMove() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T605_failbackVpMove() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    public void T1524_startVpDrill() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "start");
            Map rs = virtualizationSupport.operateVpDrill(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1524_set_statusVpDrill() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1524")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    public void T2405_attachVpFileRecovery() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "attach");
            Map rs = virtualizationSupport.operateVpFileRecovery(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T2405_startVpFileRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2405")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "start");
    ...
    @Test
    public void T2405_stopVpFileRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2405")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            args.put("operate", "stop");
