...
import com.i2soft.active.v20220622.OracleRule;
...
public class OracleRuleTest {
    ...
    @Test
    public void T2273_describeRuleDbCheckMult() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2273")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = oracleRule.describeRuleDbCheckMult(args); // 发送请求
    ...
    public void T1249_describeSyncRulesProxyStatus() {
        try {
            Map rs = oracleRule.describeSyncRulesProxyStatus(); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1291_start_analysisRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1291")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T1291_stop_analysisRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1291")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T1291_reset_analysisRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1291")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T1291_stop_and_stopanalysisRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1291")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    public void T2876_listSyncRulesGeneralStatus() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2876")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
