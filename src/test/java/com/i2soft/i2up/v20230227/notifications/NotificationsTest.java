package com.i2soft.i2up.v20230227.notifications;
...
import com.i2soft.notifications.v20230227.Notifications;
...
public class NotificationsTest {
    ...
    @Test
    public void T3136_operateNotificationsTemplate() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3136")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = notifications.operateNotificationsTemplate(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
