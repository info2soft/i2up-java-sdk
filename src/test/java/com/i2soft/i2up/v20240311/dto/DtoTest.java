package com.i2soft.i2up.v20240311.dto;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.dto.v20240311.Dto;
...
public class DtoTest {
    ...
    public void T1084_createDtoRule() {
        try {
            ...
            I2Rs.I2CreateRs rs = dto.createDtoRule(args); // 发送请求
    ...
    public void T1085_modifyDtoRule() {
        try {
            ...
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2CreateRs rs = dto.modifyDtoRule(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1089_operateDtoRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1089")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dto.operateDtoRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
