package com.i2soft.i2up.v20260626.vpBackupRule;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.vpBackupRule.v20260626.VpBackupRule;
...
public class VpBackupRuleTest {
    ...
    public void T6857_createVpBackupRule() {
        try {
            ...
            Map rs = vpBackupRule.createVpBackupRule(args); // 发送请求
    ...
    @Test
    public void T9827_batchModifyVpBackupRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9827")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = vpBackupRule.batchModifyVpBackupRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T8194_preCheckVpBackupRule() {
        try {
            byte[] rs = vpBackupRule.preCheckVpBackupRule(); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
