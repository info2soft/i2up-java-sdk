...
import com.i2soft.resource.v20260626.VirtualizationSupport;
...
public class VirtualizationSupportTest {
    ...
    @Test
    public void T10231_listUsedIp() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10231")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listUsedIp(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10272_listOrganizations() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10272")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listOrganizations(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10273_listResourceGroups() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10273")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listResourceGroups(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10345_listLianTongTenants() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10345")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listLianTongTenants(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10346_listLianTongRegions() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10346")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listLianTongRegions(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
