package com.i2soft.i2up.v20260626.backupWork;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.backupWork.v20260626.BackupWork;
...
public class BackupWorkTest {
    ...
    @Test
    public void T9164_describeBackupMigrateWorkResult() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9164")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = backupWork.describeBackupMigrateWorkResult(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T9238_downloadFailedFileList() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9238")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            byte[] rs = backupWork.downloadFailedFileList(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10131_downloadMigrateWorkList() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10131")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            byte[] rs = backupWork.downloadMigrateWorkList(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T9676_seVmpriority() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9676")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = backupWork.seVmpriority(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T9930_listBackupWorkCdpResult() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9930")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = backupWork.listBackupWorkCdpResult(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10021_listBackupVerifyWork() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10021")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = backupWork.listBackupVerifyWork(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10093_describeBackupVerifyWork() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Map rs = backupWork.describeBackupVerifyWork(uuid); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T10092_deleteBackupVerify() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "10092")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = backupWork.deleteBackupVerify(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
