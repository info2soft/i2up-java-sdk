package com.i2soft.i2up.v20260626.bigdataBackupRule;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.bigdataBackupRule.v20260626.BigdataBackupRule;
...
public class BigdataBackupRuleTest {
    ...
    @Test
    public void T9828_batchModifyBigdataBackupRule() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9828")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = bigdataBackupRule.batchModifyBigdataBackupRule(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
