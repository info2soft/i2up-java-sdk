package com.i2soft.i2up.v20250630.system;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.system.v20250630.Lic;
...
public class LicTest {
    ...
    public void T575_downloadLicInfo() {
        try {
            ...
            byte[] rs = lic.downloadLicInfo(uuid); // 发送请求
    ...
    public void T786_updateLicBind() {
        try {
            I2Rs.I2SmpRs rs = lic.updateLicBind(); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T3857_describeMoveLicBind() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "3857")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = lic.describeMoveLicBind(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
