package com.i2soft.i2up.v20260209.dtrack;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.dtrack.v20260209.Dtrack;
...
public class DtrackTest {
    ...
    @Test
    public void T1042_takeSnapshotDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.takeSnapshotDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_deleteSnapshotDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.deleteSnapshotDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_takeSnapshotCloneDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.takeSnapshotCloneDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_deleteSnapshotCloneDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.deleteSnapshotCloneDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_scanDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.scanDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_cancelScanDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.cancelScanDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_syncDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.syncDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_cancelSyncDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.cancelSyncDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_suspendDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.suspendDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1042_resumeDtrackBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1042")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = dtrack.resumeDtrackBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_suspendDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.suspendDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_resumeDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.resumeDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_syncDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.syncDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_cancelSyncDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.cancelSyncDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_takeSnapshotDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.takeSnapshotDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1408_deleteSnapshotDtrackGroup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1408")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = dtrack.deleteSnapshotDtrackGroup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
