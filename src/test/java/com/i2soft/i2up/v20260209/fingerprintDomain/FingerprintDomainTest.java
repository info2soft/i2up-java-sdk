package com.i2soft.i2up.v20260209.fingerprintDomain;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.fingerprintDomain.v20260209.FingerprintDomain;
...
public class FingerprintDomainTest {
    ...
    @Test
    public void T9105_operateFingerprintDomain() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9105")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = fingerprintDomain.operateFingerprintDomain(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
