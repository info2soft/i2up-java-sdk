package com.i2soft.i2up.v20260209.vp;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.vp.v20260209.VirtualizationSupport;
...
public class VirtualizationSupportTest {
    ...
    @Test
    public void T594_stopVpBackup() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "594")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.stopVpBackup(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T620_stopVpRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "620")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.stopVpRecovery(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T620_clearFinishVpRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "620")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.clearFinishVpRecovery(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T602_createVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "602")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.createVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T606_describeVpRep() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
    ...
    @Test
    public void T603_listVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "603")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T607_listVpRepStatus() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "607")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
    ...
    @Test
    public void T605_startVpMove() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.startVpMove(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T605_moveVpMove() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.moveVpMove(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T605_finishVpMove() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.finishVpMove(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T605_createTargeVm() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "605")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.createTargeVm(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T7632_stopVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7632")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.stopVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T7632_startVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7632")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.startVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T7632_failoverVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7632")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.failoverVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T7632_failbackVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7632")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.failbackVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T7632_startImmediatelyVpRep() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7632")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.startImmediatelyVpRep(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T752_listMovePointList() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "752")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.listMovePointList(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T9163_delPoint() {
        try {
            String uuid = UUID.randomUUID().toString().toUpperCase();
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "9163")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            I2Rs.I2SmpRs rs = virtualizationSupport.delPoint(uuid, args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1524_startVpDrill() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1524")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.startVpDrill(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T1524_setStatusVpDrill() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "1524")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.setStatusVpDrill(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
    ...
    @Test
    public void T2405_detachVpFileRecovery() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "2405")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = virtualizationSupport.detachVpFileRecovery(args); // 发送请求
            Assert.assertNotNull(rs); // 检查结果
        } catch (I2softException e) {
            e.printStackTrace();
        }
