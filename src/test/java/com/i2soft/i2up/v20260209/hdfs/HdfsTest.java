package com.i2soft.i2up.v20260209.hdfs;

import com.i2soft.common.Auth;
import com.i2soft.http.I2Rs;
import com.i2soft.http.I2softException;
import com.i2soft.http.Response;
import com.i2soft.hdfs.v20260209.Hdfs;
...
public class HdfsTest {
    ...
    public void T7108_hdfsSummary() {
        try {
            Response r = auth.client.get(String.format(TestConfig.rapDataUrl, "7108")); // 获取请求数据
            StringMap args = new StringMap().putAll(Objects.requireNonNull(r.jsonToMap())); // 填充请求数据
            Map rs = hdfs.hdfsSummary(args); // 发送请求
